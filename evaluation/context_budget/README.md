...
generated = serialize_report(generate_report(load_replay()))
assert generated == Path("evaluation/context_budget/results.json").read_bytes()
PY
```
...
production telemetry; never weaken fail-closed File Input preflight from this replay.
