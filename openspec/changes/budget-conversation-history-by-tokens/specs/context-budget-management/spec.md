...
and File Inputs. File admission MUST map the exact model, instructions, file/text
input, and reasoning fields used by create into the count request.
...
- **GIVEN** an admitted request **WHEN** mapped kwargs are compared **THEN** every count field equals its create counterpart.
